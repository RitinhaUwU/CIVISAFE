  ...
  <UModal v-model:open="open" title="Novo Voluntário" description="Criar Voluntário">
    ...
    <template #body>
      <UForm :state="state" :schema="schema" class="space-y-4" @submit="onSubmit">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
          <UFormField label="Alojamento" name="has_accommodation">
            <USwitch v-model="state.has_accommodation" />
          </UFormField>
          <UFormField v-if="state.has_accommodation" label="Localização" name="location">
